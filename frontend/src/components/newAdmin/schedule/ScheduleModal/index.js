 ...
 {/* import {Paper} from "@material-ui/core";  */}
      ...
      >
        ...
        <Modal.Body>
          ...
          {/* <div className="Modal-body">Add form field here</div> */}
          <Form>
            <Form.Group as={Row}>
            ...
            <Form.Group as={Row}>
              ...
              <Col sm={8}>
                <Form.Check inline type="radio" label="Big Blue Button" name="platform" id='bigbluebutton' zoom='bigbluebutton' onChange={(e) => inputChangeHandler(e, "platform")}
                ...
                <Form.Check inline type="radio" label="Zoom" name="platform" id='zoom' value="zoom" onChange={(e) => inputChangeHandler(e, "platform")}
                  onBlur={(e) => inputBlurHandler(e, "platform")} />
                <Form.Check inline type="radio" label="Liveclass" name="platform" id='liveclass' value="liveclass" onChange={(e) => inputChangeHandler(e, "platform")}
                  onBlur={(e) => inputBlurHandler(e, "platform")} />
              </Col>
              <span className="error-message">
