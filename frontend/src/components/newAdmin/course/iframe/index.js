...
const VideoPlayer = (props) => {
  ...
  return (
    <div className="iframe_background" style={{ marginLeft: "-3%",marginTop:"5px"}}>
      {loader ? (
          ...
          >
            ...
            <Accordion defaultActiveKey={1}>
              {moduleData.chapters.map((chapter, index) => (
                ...
                <Card id="card-accordian" key={index} style={{height:"100%"}}>
                  <Accordion.Toggle as={Card.Header} eventKey={index + 1}>
                    {/* {chapter.name} */}
                    <span  style={{marginTop:"5px",fontSize:"20px",color:"#175592"}}>{chapter.name}</span>
                  </Accordion.Toggle>
                  <Accordion.Collapse eventKey={index + 1}  
                  style={{}}
                  >
                    <Card.Body id="card-accordian-body"  style={{marginTop:"20px",marginBottom:"20px",height:"1000px"}}>
