...
import signInImage from "../../../../../images/heroImage.png";
import { Button, Container, Col, Row, Form } from "react-bootstrap";
import Alert from "../../../../../shared/Components/Alert";

const StudentSighUP = (props) => {
  let {
    loader,
    inputBlurHandler,
    inputChangeHandler,
        ...
        <div className="main-login-div-signup-m">
          <Container>
            <Row xs={1} md={12} sm={12} lg={12}>
              <Col md={5} xs={12} sm={12} lg={5} className="hideFirstColViaMob">
                      ...
                      <Form.Group>
                        <Row>
                          <Col md={12} xs={12} sm={12} lg={12}>
                            <p id="OTP-signup-m">
                              OTP sent on Email {props.match.params.email}
                            </p>
                          </Col>
                        </Row>
                      </Form.Group>
...
export default enhancer(StudentSighUP);
